...
\lean{AInfinityTheory.GradingIndex}
\label{AInfinityTheory.GradingIndex}
\leanok
...
\lean{AInfinityTheory.shiftOfInt}
\label{AInfinityTheory.shiftOfInt}
\leanok
\uses{AInfinityTheory.GradingIndex}
For a grading index $\beta$, \lean{AInfinityTheory.shiftOfInt} is the image of
$n \in \mathbb{Z}$ under the distinguished map $\phi : \mathbb{Z} \to \beta$.
\end{definition}
